    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end mb-3">
                <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#resetArsip">Reset Arsip</button>
            </div>
            <!-- BATAS -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <strong> Data arsip bulan <?= bulan($bulan) ?> Tahun <?= $tahun ?>.</strong><br>
                                        Apakah anda yakin menghapus item ini ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">TIDAK</button>
                                        <a href="<?= base_url('admin/arsip/hapus_arsip/') . $key->bulantahun ?>" class="btn btn-dark">YA</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="resetArsip" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Semua data Arsip akan dkosongkan!</strong><br>
                Apakah anda ingin melanjutkan ?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">TIDAK</button>
                <a href="<?= base_url('admin/arsip/reset_arsip/') ?>" class=" btn btn-dark">RESET</a>
            </div>
        </div>
    </div>
</div>
